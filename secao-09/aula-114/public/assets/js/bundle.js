...
var geraMaiusculo = function geraMaiusculo() {
...
function geraSenha(qtd, maiusculas, minusculas, numeros, simbolos) {
  ...
  var novaSenha = senhaArray.join('').slice(0, quantidade);
  return novaSenha;
}
